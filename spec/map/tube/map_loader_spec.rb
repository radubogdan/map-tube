...
describe Map::Tube::MapLoader do
  let(:valid_map) { Map::Tube::MapLoader.new("Bucharest") }
  let(:invalid_map) { Map::Tube::MapLoader.new("MyCity", "data/mycity-map.xml") }

  describe ".initialize" do
    it "should get a city name and automatically setup the path" do
      expect(valid_map.map_path).to eq "data/bucharest-map.xml"
    end
